...
class Enemy:
    def __init__(self, screen, pos, tiles, player):
        ...
        self.spritesheet = pygame.image.load('assets/sprites/game/player_spritesheet.png').convert_alpha()
        self.jump_sprites = [
            (112, 0),
            (144, 0),
        ]
...
class BlueEnemy(Enemy):
    def __init__(self, screen, pos, tiles, player):
        super().__init__(screen, pos, tiles, player)
        self.spritesheet = utils.color_swap_image(pygame.image.load('assets/sprites/game/player_spritesheet.png').convert_alpha(), (255, 0, 0), (0, 0, 255))


class GreenEnemy(Enemy):
    def __init__(self, screen, pos, tiles, player):
        super().__init__(screen, pos, tiles, player)
        self.spritesheet = utils.color_swap_image(pygame.image.load('assets/sprites/game/player_spritesheet.png').convert_alpha(), (255, 0, 0), (0, 255, 0))
        self.speed = 200
        self.jump_power = 300