...
class Button:
    def __init__(self, screen, position, text, font_size=12, text_color=(0, 0, 0), color=(255, 255, 255)):
        ...
        self.normal_sprite = pygame.transform.scale2x(pygame.image.load('assets/sprites/ui/button.png').convert_alpha())
        self.click_sprite = pygame.transform.scale2x(pygame.image.load('assets/sprites/ui/button_click.png').convert_alpha())
